"""FastAPI and FastMCP transport adapters."""
...
from flink_codex.job_service import create_flink_job_service, normalize_request
...
async def generate_normalized_request(request: JobRequest) -> NormalizedJobRequest:
    """Normalize a request after validation."""
...
async def create_flink_job(
    ...
    sample_source_records: list[dict] | None = None,
    ...
    return await create_flink_job_service(
